...
function createHorizontalTree(treeData){
    $('#luposgraph svg').hide();
    ...
    var baseSvg = d3.select("#luposgraph").append("svg").attr("id","luposgraph-horizontal-tree")
        .attr("width", w)
        .attr("height", h)
        .attr("class", "overlay")
        .call(zoomListener);
...
//            });
        ...
        node.select('text')
            ...
            .attr("y", function(d) {
                var value = d.children || d._children ? 5 : 0;
                if(d.hasOwnProperty("x0")) value = 0;
                return value;
            })
